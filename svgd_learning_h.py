...
iter = 0
target_distr = utils_2.hydrogen_probability(alpha)
...
while gradient_norm > 1e-4 and iter < 1000:
    print(iter)
    energies_list.append(utils_2.variational_energy_h(walkers, alpha))
    gradient = utils_2.gradient_variational_energy_h_2(walkers, alpha)
